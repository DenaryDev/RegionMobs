...
public class Settings {
    ...
    public static void load(Path path) throws ConfigurateException {
        ...
        main = CrystalConfigs.loadConfig(path.resolve("settings.conf"), serializers, Main.class, false);
    ...
    public static final class Main {
        ...
        public static final class MobSpawn {
            ...
            @Comment("Минимальный размер стека мобов")
            public int minCapSize = 2;
            @Comment("Максимальный размер стека мобов")
        ...
        public static final class Commands {
            ...
            public static final class Edit {
                ...
                public static final class World {
                    public String info = "Устанавливает мир, в котором будет работать область";
                    public String success = "<prefix>Вы установили мир <yellow><world><white> для области <yellow><id><white>.";
                    public String invalidWorld = "<prefix>Мир <yellow><world> <white>не найден!";
                }
