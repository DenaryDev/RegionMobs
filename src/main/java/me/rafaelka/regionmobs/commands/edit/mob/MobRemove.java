...
public class MobRemove extends Mob {
    ...
    @Override
    public String info() {
        return Settings.messages().commands.edit.mob.remove.info;
    }
        ...
        return root().then(argument("type", word())
            ...
            .executes(context -> {
                ...
                if (!region.hasMob(entity)) {
                    sendMessage(source, Settings.messages().commands.edit.mob.remove.notFound,
                ...
                sendMessage(source, Settings.messages().commands.edit.mob.remove.success,
                    Placeholder.unparsed("id", region.id()),
                    Placeholder.unparsed("type", entity.name().toLowerCase())
                );
