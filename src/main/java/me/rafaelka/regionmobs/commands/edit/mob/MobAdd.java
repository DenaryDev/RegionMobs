...
public class MobAdd extends Mob {
    ...
    @Override
    public String info() {
        return Settings.messages().commands.edit.mob.add.info;
    }
        ...
        return root().then(argument("type", word())
            ...
            .executes(context -> {
                ...
                if (region.hasMob(entity)) {
                    sendMessage(source, Settings.messages().commands.edit.mob.add.already,
                ...
                sendMessage(source, Settings.messages().commands.edit.mob.add.success,
                    Placeholder.unparsed("id", region.id()),
                    Placeholder.unparsed("type", entity.name().toLowerCase())
                );
